...
class AssortedScans extends MangAdventure_1.MangAdventure {
    constructor() {
        super(...arguments);
        /** @inheritDoc */
        this.baseUrl = exports.AssortedScansInfo.websiteBaseURL;
        /** @inheritDoc */
        this.version = exports.AssortedScansInfo.version;
        /** @inheritDoc */
        this.longStripIds = [
            'creepy-cat',
            'mad-webcomic',
...
exports.AssortedScans = AssortedScans;
